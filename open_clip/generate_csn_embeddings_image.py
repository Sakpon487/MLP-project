#!/usr/bin/env python3
"""Generate image-only CSN embeddings from a trained checkpoint."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Generate image-only CSN embeddings from checkpoint")
